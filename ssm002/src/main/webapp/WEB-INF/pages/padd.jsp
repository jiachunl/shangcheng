...
<head>
    ...
    <meta http-equiv="${path}/static/Cache-Control" content="no-siteapp" />
...
<div class="page-container">
            <form action="addCategory.do" method="post" class="form form-horizontal" id="form-article-add">
                <div class="row cl">
...
<script type="text/javascript" src="${path}/static/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="${path}/static/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="${path}/static/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
